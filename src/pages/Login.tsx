...
const Login = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (success) {
        toast.success("Yebo! Welcome back! 🎉");
        navigate("/");
      } else {
        toast.error("Eish! Wrong email or password, my bru 😅");
      }
    } catch (error) {
      toast.error("Haibo! Something went wrong 😬");
    } finally {
      setIsLoading(false);
    }
  };
      ...
      <div className="flex-1 flex items-center justify-center py-12 px-4 bg-gradient-to-br from-primary/10 via-background to-secondary/10">
        <Card className="w-full max-w-md">
          <CardHeader className="space-y-1 text-center">
            ...
            <CardTitle className="text-2xl font-bold">Welcome Back, Fam! 👋</CardTitle>
            <CardDescription>
